...
SECRET_KEY = 'django-insecure-m!jb-9o=+nj8^15cr=xy_q+vb-u_h$19yk@uekvmtoe++-sbs^'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Указываем, что медиафайлы находятся в папке media
