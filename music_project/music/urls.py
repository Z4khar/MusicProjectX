...
from .views import TrackViewSet, PlaylistViewSet, FavoriteTrackViewSet  # Импортируем все ViewSet
...
router.register(r'favorite-tracks', FavoriteTrackViewSet)  # Добавляем маршрут для избранных треков
